          ...
          child: SingleChildScrollView(
            child: Column(
              children: const [
                ...
                Divider(),
                Text("3. Avertissement de santé", style: TextStyle(fontWeight: FontWeight.bold)),
                ...
                Divider(),
                Text("4. Responsabilité", style: TextStyle(fontWeight: FontWeight.bold)),
                ...
                Divider(),
                Text("5. Propriété intellectuelle", style: TextStyle(fontWeight: FontWeight.bold)),
                ...
                Divider(),
                Text("6. Modification du Contrat", style: TextStyle(fontWeight: FontWeight.bold)),
                ...
                Divider(),
                Text("7. Résiliation", style: TextStyle(fontWeight: FontWeight.bold)),
                ...
                Divider(),
                Text("8. Loi applicable et juridiction", style: TextStyle(fontWeight: FontWeight.bold)),
                ...
                Divider(),
                Text("9. Acceptation du Contrat", style: TextStyle(fontWeight: FontWeight.bold)),
                ...
                Divider(),
                Text("10. Contactez-nous", style: TextStyle(fontWeight: FontWeight.bold)),
